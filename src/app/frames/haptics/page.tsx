...
export default function Page() {
  ...
  useEffect(() => {
    const initApp = async () => {
      ...
      const hasNotificationOccurred = capabilities.includes(
        "haptics.notificationOccurred"
      );
      const hasSelectionChanged = capabilities.includes(
        "haptics.selectionChanged"
      );
      setHasHaptics(
        hasImpactOccurred && hasNotificationOccurred && hasSelectionChanged
      );
      setIsSDKLoaded(true);
    };
